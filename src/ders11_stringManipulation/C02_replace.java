...
public class C02_replace {
    ...
    public static void main(String[] args) {
        ...
        String str5 = "Aydeniz ailesi İzmir'e gidiyor.";
        System.out.println(str5.replace("İzmir", "İZMİR"));
        System.out.println(str5.replace("İzmir'e","İstanbul'a" ));
        System.out.println(str5.replaceAll("i", ""));
        System.out.println(str5.replaceAll("Aydeniz ailesi" , "Fazıl")
                            .replaceAll("İzmir'e","İstanbul'a" ));
